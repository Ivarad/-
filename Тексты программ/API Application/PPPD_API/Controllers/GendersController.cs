...
namespace PPPD_API.Controllers
{
    ...
    public class GendersController : ControllerBase
    {
        ...
        public GendersController(PPPDContext context)
        {
            _context = context;
        }
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<Gender>> PostGender([FromBody] Gender gender)
        {
            _context.Genders.Add(gender);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetGender", new { id = gender.IdGender }, gender);
        }
